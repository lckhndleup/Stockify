...
export default function CollectionResult() {
  ...
  const brokerIdParam = params.brokerId;
  const amountParam = params.amount;
  const paymentTypeParam = params.paymentType;
  const paymentTypeLabelParam = params.paymentTypeLabel;
  const downloadUrlParam = params.downloadUrl;
  const previousBalanceParam = params.previousBalance;
  const newBalanceParam = params.newBalance;
  ...
  const handleNewCollection = () => {
    ...
    navigation.navigate('BrokerDetail', { brokerId: String(brokerIdParam) });
  };
