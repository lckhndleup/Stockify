...
export const queryKeys = {
  ...
  brokers: {
    ...
    list: (filters?: any) => [...queryKeys.brokers.lists(), filters] as const,
    details: () => [...queryKeys.brokers.all, "detail"] as const,
    detail: (id: string) => [...queryKeys.brokers.details(), id] as const,
    transactions: (id: string) =>
      [...queryKeys.brokers.detail(id), "transactions"] as const,
    debt: (id: string) => [...queryKeys.brokers.detail(id), "debt"] as const,
    statements: (id: string) =>
      [...queryKeys.brokers.detail(id), "statements"] as const,
    invoices: (id: string) =>
      [...queryKeys.brokers.detail(id), "invoices"] as const,
  },
  ...
  stock: {
    ...
    movement: (filters?: any) =>
      [...queryKeys.stock.movements(), filters] as const,
  ...
  invoices: {
    ...
    broker: (brokerId: string) =>
      [...queryKeys.invoices.all, "broker", brokerId] as const,
  },
  ...
  dashboard: {
    ...
    recentActivities: () =>
      [...queryKeys.dashboard.all, "recent-activities"] as const,
  },
} as const;
